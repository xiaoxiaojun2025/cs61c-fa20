...
class TestDot(TestCase):
    def test_simple(self):
        ...
        array0 = t.array([1, 4, 7, -1, 0, 5])
        array1 = t.array([0, -8, 7, 2, -2, 6])
        ...
        t.execute()
    def test_stride_not_equal(self):
        t = AssemblyTest(self, "dot.s")
        array0 = t.array([1, 3, 5, 7])
        array1 = t.array([2, 0, 4, 0, 6, 0, 8])
        t.input_array("a0", array0)
        t.input_array("a1", array1)
        t.input_scalar("a2", 4)
        t.input_scalar("a3", 1)
    ...
    def test_length_less_than_one(self):
        ...
        t.check_scalar("a0", 100)
        t.execute(code=75)
    def test_stride_less_than_one_v0(self):
        t = AssemblyTest(self, "dot.s")
        array0 = t.array([1, 3, 5, 7])
        array1 = t.array([2, 0, 4, 0, 6, 0, 8])
        t.input_array("a0", array0)
        ...
        t.check_scalar("a0", 100)
        t.execute(code=76)
    def test_stride_less_than_one_v1(self):
        t = AssemblyTest(self, "dot.s")
        array0 = t.array([1, 3, 5, 7])
        array1 = t.array([2, 0, 4, 0, 6, 0, 8])
        t.input_array("a0", array0)
...
class TestMatmul(TestCase):
    ...
    def test_border_of_m0_01(self):
        self.do_matmul(
            [1, 2, 3, 4, 5, 6, 7, 8, 9], -3, 3,
            [1, 2, 3, 4, 5, 6, 7, 8, 9], 3, 3,
            [30, 36, 42, 66, 81, 96, 102, 126, 150], 72
        )
    def test_border_of_m0_02(self):
        self.do_matmul(
            [1, 2, 3, 4, 5, 6, 7, 8, 9], 3, -3,
            [1, 2, 3, 4, 5, 6, 7, 8, 9], 3, 3,
            [30, 36, 42, 66, 81, 96, 102, 126, 150], 72
        )
    def test_border_of_m1_01(self):
        self.do_matmul(
            [1, 2, 3, 4, 5, 6, 7, 8, 9], 3, 3,
            [1, 2, 3, 4, 5, 6, 7, 8, 9], -3, 3,
            [30, 36, 42, 66, 81, 96, 102, 126, 150], 73
        )
    def test_border_of_m1_02(self):
        self.do_matmul(
            [1, 2, 3, 4, 5, 6, 7, 8, 9], 3, 3,
            [1, 2, 3, 4, 5, 6, 7, 8, 9], 3, -3,
            [30, 36, 42, 66, 81, 96, 102, 126, 150], 73
        )
    def test_border_of_m0_with_m1(self):
        self.do_matmul(
            [1, 2, 3, 4, 5, 6, 7, 8, 9], 3, 3,
...
class TestWriteMatrix(TestCase):
    ...
    def do_write_matrix_without_check(self, fail='', code=0):
    ...
    def test_fopen_fail(self):
        self.do_write_matrix_without_check('fopen', 93)
    def test_fwrite_fail(self):
        self.do_write_matrix_without_check('fwrite', 94)
    def test_fclose_fail(self):
        self.do_write_matrix_without_check('fclose', 95)
